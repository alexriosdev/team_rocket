...
class RandomStudents(sprite1):
   def __init__(self, screen, image, x,y, vx,vy,accel):
      ...
      self.rect = pygame.Rect(self.position.x + 30  , self.position.y, self.image.get_width() - 68, self.image.get_height())
      self.clip = pygame.Rect( 0, 0, 160, 180 )
      #random student genarator
      number = random.randint(2,4)
      print number
      if(number == 2):
         self.images = [pygame.image.load('Images/student1.png').convert_alpha(),pygame.image.load('Images/student2.png').convert_alpha()]
      if(number == 2):
         self.images = [pygame.image.load('Images/student3.png').convert_alpha(),pygame.image.load('Images/student4.png').convert_alpha()]
      if(number ==3):
         self.images = [pygame.image.load('Images/student5.png').convert_alpha(),pygame.image.load('Images/student6.png').convert_alpha()]
      if(number ==4):
         self.images = [pygame.image.load('Images/student7.png').convert_alpha(),pygame.image.load('Images/student8.png').convert_alpha()]   
