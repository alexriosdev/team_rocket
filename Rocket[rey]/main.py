...
def game_loop():
    ...
    while not gameExit:
        ...
        if int(score) % 750 == 0:
            randomstudents =  RandomStudents( screen, "Images/student1.png", random.randint(192, 832), random.randint(0, 191), 0, 1, random.uniform(0.03, .01))
            list.insert(0,randomstudents)
        if int(score) % 750 == 0:
            randomstudents =  RandomStudents( screen, "Images/student3.png", random.randint(192, 832), random.randint(0, 191), 0, 1, random.uniform(0.03, .01))
            list.insert(0,randomstudents)
        if int(score) % 750 == 0:
            professor =  Professor( screen, "Images/professor1.png", random.randint(192, 832), random.randint(0, 191), 0, 1, .008)
            list.insert(0,professor)
